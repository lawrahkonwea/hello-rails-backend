...
<a href="https://github.com/lawrahkonwea/hello-react-front-end.git">Front-end is here</a>
...
```sh
  git clone https://github.com/lawrahkonwea/hello_react_rails.git
```
...
- LinkedIn: [amakalaurakonwea](https://linkedin.com/in/amakalaurakonwea)
